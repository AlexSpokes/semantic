#note, I found this intersting. I play a game called contexto which is similar
#another example is economony, very closely linked to country but not England
#comparing sm with md, the values are generally more similar with the more specific md version
